...
namespace App.Utilities
{
    public class AppUtilities
    {
        ...
        public static void ResizeImageAsync(string imageName, int height, int width)
        {
            var imgPath = Path.Combine(Directory.GetCurrentDirectory(), "image", imageName);

            using (var image = Aspose.Imaging.Image.Load(imgPath))
            {
